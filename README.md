...
Simply copy the file `zaf.jl` in your working directory, run `include("./zaf.jl"); using .zaf`, and you are good to go. Make sure to have the following packages installed (with `Pkg.add("name_of_the_package")`):
