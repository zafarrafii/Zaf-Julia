...
- [DSP](https://docs.juliadsp.org/stable/contents/): provides a number of common digital signal processing routines in Julia *(not actually used in the functions but for the examples)*.
